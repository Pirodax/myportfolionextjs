  ...
  return (
    <div className="py-20" id="projects">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10 p-4">
        {sortedProjects.map(({ id, title, title_en, des, des_en, img, iconLists, link }, index) => {
          const displayTitle = language === 'en' && title_en ? title_en : title;
          const displayDes = language === 'en' && des_en ? des_en : des;
          return (
            <ActiveLink href={`/project${id}`} key={id}>
              <div className={`sm:h-[41rem] lg:min-h-[32.5rem] h-[32rem] flex items-center justify-center sm:w-[570px] w-[80vw] ${
                ...
                <PinContainer title={displayTitle} href={link}>
